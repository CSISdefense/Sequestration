...
data1 <- read.csv("data3.csv")

SubCustomer1 <- levels(data1$SubCustomer) 
VendorSize1 <- levels(data1$VendorSize)
Category1 <- levels(data1$VendorSize)
  ...
  fluidPage(
    ...
    fluidRow(
      ...
      column(2, align = 'center',
             ...
             selectInput("VendorSize","VendorSize", VendorSize1,
                         multiple = TRUE,
                         selectize = FALSE,
                         selected = VendorSize1,
                         width = '100%',
                         size = 4),

             # Settings for Customer select
             selectInput("SubCustomer","SubCustomer", SubCustomer1,
                         multiple = TRUE,
                         selectize = FALSE,
                         selected = SubCustomer1,
                         width = '100%',
                         size = 6)
