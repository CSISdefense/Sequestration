...
/****** Object:  View [Vendor].[EntityIDhistory]    Script Date: 1/14/2018 2:20:57 PM ******/
SET ANSI_NULLS ON
GO
...
AS
	...
	, CASE
		...
		THEN 'PDuns-2'
		WHEN HasParentDunsnumber=1 and ParentDunsChildCount>=3
		THEN 'PDuns-3+'
		...
		THEN 'PDuns-2'
		WHEN HasParentDunsnumberImputed=1 and ParentDunsImputedChildCount>=3
		THEN 'PDuns-3+'
	--	--Even if using Dunsnumber here other entries may think of this as a parent.
		...
		THEN 'PDuns-2'
		WHEN EID.dunsnumber is not null  and DunsChildCount>=3
		THEN 'PDuns-3+'
